...
func (s *Server) Serve() {
	...
	router.HandleFunc("/healthz", s.Healthz).Methods("GET", "OPTIONS")
	router.HandleFunc("/api/v1/stat", s.Stat).Methods("GET", "OPTIONS")
	router.HandleFunc("/api/v1/price", s.Price).Methods("GET", "OPTIONS")
	router.HandleFunc("/api/v1/syrup", s.Syrup).Methods("GET", "OPTIONS")
